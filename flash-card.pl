...
my $sentences = [
    ...
    [ 'De man is ziek.'              => 'The man is sick.' ],             #I'm never sure about "sick", that could mean you have to throw up right? I'd probably translate with "ill", but maybe that is too grave.
    [ 'De man is beter.'             => 'The man is better.' ],
    [ 'De vrouw kijt naar de man.'   => 'The woman looks at the man.' ],
    ...
    [
        'De man heeft anderen kleren dan de vrouw.' =>
          'The man has different clothing than the woman.'                #I thought this would have to be "The man has different clothes than the woman". I think there is literal translation for clothing, which would be "kledij" which is a rather archaic word.
    ],
    [ 'Zij is blij.'   => 'She is happy.' ],
    [ 'zij is alleen.' => 'She is alone.' ],
    [
        'Er zit een aantal mensen op de bank.' =>
          'There are a number of people seated on the bench.'
    ],
...
my $other_vocab = [
    ...
    [ 'veel'        => 'many' ],
    [ 'weinig'      => 'few' ],
    [ 'beneden'     => 'down' ],            # below ? Depends, could be either down, below, beneath, downstairs depending on specific sentence.
    [ 'boven'       => 'above' ],
    [ 'vol'         => 'full' ],
    [ 'leeg'        => 'empty' ],
    [ 'vies'        => 'dirty' ],
    [ 'schoon'      => 'clean' ],
    [ 'koud'        => 'cold' ],
    [ 'typen'       => 'type' ],            #as a verb, typen is to type. But typen could also be the plural of type as in kind, so "types" in English.
    [ 'lezen'       => 'read' ],
    [ 'schrijven'   => 'write' ],
    [ 'kijken'      => 'look' ],
    [ 'licht'       => 'light' ],
    ...
    [ 'lachen'      => 'laugh' ],
    [ 'wassen'      => 'wash' ],
    [ 'voetballen'  => 'play football' ],     # probably soccer?
    [ 'dubbel'      => 'double' ],
    [ 'spelen'      => 'play' ],
    [ 'spellen'     => 'spell' ],
    [ 'spreken'     => 'speak' ],
    [ 'vroeger'     => 'former' ],            # could also be "in the past" or "earlier"
    [ 'nu'          => 'now' ],
    [ 'moelijk'     => 'hard' ],              # difficult
    [ 'makkelijk'   => 'easy' ],
    [ 'vandaag'     => 'today' ],
    [ 'morgen'      => 'tomorrow' ],
    [ 'gisteren'    => 'yesterday' ],
    ...
    [ 'voorstellen' => 'introduce' ],         # depends on context. "Ik zal me even voorstellen" -> "I'll introduce myself". "Ik kan me dat moeilijk voorstellen" -> "I find that hard to imagine"
    [ 'printen'     => 'print' ],
    [ 'slepen'      => 'drag' ],
    [ 'trekken'     => 'pull' ],
    [ 'kiezen'      => 'choose' ],
    ...
    [ 'hier'        => 'here' ],
    [ 'daar'        => 'daar' ],
    [ 'gek'         => 'crazy' ],             # could be many things "odd","funny" (not haha), "cool" (as in, hip)
    [ 'normaal'     => 'normal' ],
    [ 'zoeken'      => 'look' ],              # search
    [ 'mijmeren'    => 'contemplate' ],       # bedenken is when you invent something in your mind, to make up
    [ 'koken'       => 'cook' ],
];
...
my $het_de = [
    ...
    [ 'de prijs'        => 'the price' ],
    [ 'de boodschappen' => 'the shopping' ],      #typically groceries. But literally, boodschappen are messages. Some room for confusion: "Ik heb een belangrijke boodschap" -> "I have an important message". "Ik moet even een boodschap doen" -> "I need to do some shopping". "Ik moet een grote boodschap doen" -> "I need to do a number two."
    [ 'De pijn'         => 'The pain' ],
    ...
    [ 'het stuk'        => 'the piece' ],         #careful :) depending on context, "stuk" could mean a goodlooking woman ("Kijk dat stuk eens!"), or a euphemism for penis. ("Mijn stuk staat op scherp")
    [ 'de meter'        => 'the meter' ],
    [ 'de brand'        => 'the fire' ],
];
...
my $too_easy = [
    ...
    [ 'groot'     => 'big' ],
    [ 'goed'      => 'goed' ],
    [ 'oke'       => 'okay' ],      # should be "ok\N{U+00E9}", but whatever
    [ 'drinken'   => 'drink' ],
    [ 'eten'      => 'eat' ],
    [ 'plus'      => 'plus' ],
    [ 'warm'      => 'warm' ],
    [ 'lekker'    => 'nice' ],      # good, tasty, whatever
    [ 'werk'      => 'work' ],
    [ 'hallo'     => 'hello' ],
    [ 'tot ziens' => 'see you' ],
    [ 'hoi'       => 'hi' ],
