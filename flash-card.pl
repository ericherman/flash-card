...
my $sentences = [
    ...
    [ 'Hij geert informatie.'        => 'He gives information.' ],
    ...
    [ 'Ik werk in dit dedrijf.'      => 'I work in this building.' ],
    ...
    [
        'Er zit een aantal mensen op de bank.' =>
          'There are a number of people on the bench.'
    ],
    ...
    [ 'Zij gaan op vakantie.'       => 'They goon vacation.' ],
